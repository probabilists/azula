# Adapted from
# https://github.com/LTH14/JiT/blob/869190a33f59271724cd1bfddd85777501dadf03/model_jit.py
...
from .util import RMSNorm, VisionRotaryEmbeddingFast, get_2d_sincos_pos_embed
